function varargout = argfill(vin, minin,defvals, efillf)
% checks number of varargin arguments and fills with defaults
% FORMAT varargout = phiw_argfill(vin, minin, defvals, efillf)
%
% Inputs [default]
...
if l > nargout
  warning(...
      sprintf('%d varargin args passed. Function expects at most %d args', ...
	      l, nargout));
end
ld = length(defvals);
if ld<nargout
