function [o, others] = phido_2(des, params)
% class constructor for SPM2 phiwave design object
% FORMAT [o, others] = phido_2(des, params)
%
% Inputs 
...
% with a phido object as input.  phido_2 checks to see
...
%
% $Id: phido_2.m,v 1.1 2004/09/16 06:19:39 matthewbrett Exp $
...
if isa(des, 'phido')
  ...
  if ~strcmp(type(des), 'spm2'), o = des; return, end
  uo = des;
  des = [];
else
  uo = [];
