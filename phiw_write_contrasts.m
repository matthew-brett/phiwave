function [rxCon, wave, connos, spmmat, rmsi] = phiw_write_contrasts(varargin) 
% Writes contrast and statistic images
% FORMAT [rxCon, wave, connos, spmmat, rmsi] = 
...
% wave        - structure containing wavelet transformation parameters
% connos     - vector of contrast numbers (as input, or from GUI) 
% spmmat     - structure from SPM.mat file
